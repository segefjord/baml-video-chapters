...
// @ts-ignore
const { FFmpeg } = await import('https://ai-chapters.vercel.app//ffmpeg/ffmpeg/dist/esm/index.js');
// @ts-ignore
const { fetchFile, toBlobURL } = await import('https://ai-chapters.vercel.app/ffmpeg/util/dist/esm/index.js');
